...
>(({ className, ...props }, ref) => (
  <div className={cn("absolute left-0 top-full flex justify-center")}>
    <NavigationMenuPrimitive.Viewport
      ...
      style={{ boxShadow: "0 10px 24px rgba(42, 44, 65, 0.12)" }}
      ref={ref}
      {...props}
    />
  </div>
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ...
    {...props}
  >
    <div className="relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm bg-border" style={{ boxShadow: "0 2px 8px rgba(42, 44, 65, 0.1)" }} />
  </NavigationMenuPrimitive.Indicator>
));
